...
plt.xlabel("x")
plt.ylabel("y")
plt.title("Sinus funkcija un taas atvasinaajumi")
plt.plot(x, y, "k")
...
legend.append("atvasinaajums (izmantojot vertiibas no masiiva)")

plt.plot(x[0:N-1], derivative_through_array, "bo")
legend.append("atvasinaajums (izmantojot vertiibas no masiiva) ;dazhi punkti")
